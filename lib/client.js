...
ModeShapeClient.prototype.getEndPointUrl = function(path){
    ...
    var fullPath = this._buildPath(this.options.context, path || '');
...
ModeShapeClient.prototype.addNode = function(options, node, callback) {
    ...
    var fullPath = this._buildPath(options, internals.endpoints.ITEMS, options.path);
...
ModeShapeClient.prototype.deleteNode = function(options, callback) {
    ...
    var path = this._buildPath(options, internals.endpoints.ITEMS, options.path);
...
ModeShapeClient.prototype.getNodeByIdentifier = function(options, callback) {
    ...
    var path = this._buildPath(options, internals.endpoints.NODES, options.id);
...
ModeShapeClient.prototype.executeJCRQuery = function(options, callback) {
    ...
    if(options.filters) {
        options.queryString = options.filters;
    }

    var path = this._buildPath(options, internals.endpoints.QUERY);
...
ModeShapeClient.prototype.addMultipleNodes = function(options, nodes, callback) {
    ...
    var path = this._buildPath(options, internals.endpoints.ITEMS);
...
ModeShapeClient.prototype.getNodeType = function(options,callback) {
    ...
    var path = this._buildPath(options, internals.endpoints.NODETYPES, options.nodeTypeName);
    this.executeRequest(internals.GET_METHOD, path, null, function(err, res) {
...
ModeShapeClient.prototype.createBinaryProperty = function(options, binaryStream, callback) {
    ...
    var path = this._buildPath(options, internals.endpoints.BINARY, options.path);
...
ModeShapeClient.prototype.uploadBinary = function(options, binaryStream, callback) {
    ...
    var path = this._buildPath(options, internals.endpoints.UPLOAD, options.path);
    var requestOptions = internals.buildOptionsWithPlainPayload(binaryStream);
    this.executeRequest(internals.POST_METHOD, path, requestOptions, function(err, res) {
...
ModeShapeClient.prototype._buildPath = function() {
    ...
    var url = path.join.apply(null, args);
    if(options.queryString) {
        var queryString = '?' + querystring.stringify(options.queryString);
        url = url + queryString;
    }
    return url;
};
