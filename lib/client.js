...
ModeShapeClient.prototype.addNode = function(options, node, callback) {
    ...
    var fullPath = internals.buildPath(options.repository, options.workspace, internals.endpoints.ITEMS, options.path);
    var requestOptions = this._buildOptionsWithJSONPayload(node);
...
ModeShapeClient.prototype.updateNode = function(options, nodeProperties, callback) {
    ...
    var fullPath = internals.buildPath(options.repository, options.workspace, internals.endpoints.ITEMS, options.path);
    var requestOptions = this._buildOptionsWithJSONPayload(nodeProperties);
...
ModeShapeClient.prototype.deleteNode = function(options, callback) {
    ...
    var path = internals.buildPath(options.repository, options.workspace, internals.endpoints.ITEMS, options.path);
...
ModeShapeClient.prototype.getNodeByIdentifier = function(options, callback) {
    ...
    var path = internals.buildPath(options.repository, options.workspace, internals.endpoints.NODES, options.id);
...
ModeShapeClient.prototype.executeJCRQuery = function(options, callback) {
    ...
    var path = internals.buildPath(options.repository, options.workspace, internals.endpoints.QUERY) + queryString;

    var requestOptions = this._buildOptionsWithPlainPayload(options.query);
...
ModeShapeClient.prototype.addMultipleNodes = function(options, nodes, callback) {
    ...
    var path = internals.buildPath(options.repository, options.workspace, internals.endpoints.ITEMS);

    var requestOptions = this._buildOptionsWithJSONPayload(nodes);
    this.executeRequest(internals.POST_METHOD, path, requestOptions, function(err, res) {
...
ModeShapeClient.prototype._buildOptionsWithJSONPayload = function(jsonPayload) {
...
ModeShapeClient.prototype._buildOptionsWithPlainPayload = function(payload) {
